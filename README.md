...
| <a name="module_monitor_autoscale_setting"></a> [monitor\_autoscale\_setting](#module\_monitor\_autoscale\_setting) | git::https://github.com/launchbynttdata/tf-azurerm-module_primitive-monitor_autoscale_setting.git | main |
