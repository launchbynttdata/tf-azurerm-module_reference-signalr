...
| <a name="module_signalr"></a> [signalr](#module\_signalr) | git::https://github.com/launchbynttdata/tf-azurerm-module_primitive-signalr.git | fix/autoscaling |
...
| <a name="module_monitor_autoscale_setting"></a> [monitor\_autoscale\_setting](#module\_monitor\_autoscale\_setting) | git::https://github.com/launchbynttdata/tf-azurerm-module_primitive-monitor_autoscale_setting.git | 1.0.0 |
...
| <a name="input_autoscale_predictive"></a> [autoscale\_predictive](#input\_autoscale\_predictive) | Optional predictive autoscale configuration.<br/>scale\_mode      = The predictive scale mode (Disabled, Enabled, ForecastOnly).<br/>look\_ahead\_time = (Optional) Amount of time instances are launched in advance in ISO 8601 format (PT1M to PT1H). | <pre>object({<br/>    scale_mode      = string<br/>    look_ahead_time = optional(string)<br/>  })</pre> | `null` | no |
