...
| <a name="input_action_groups"></a> [action\_groups](#input\_action\_groups) | n/a | <pre>map(object({<br>    action_group_name  = string<br>    short_name         = string<br>    arm_role_receivers = optional(set(string))<br>    email_receivers    = optional(set(string))<br>  }))</pre> | `{}` | no |
