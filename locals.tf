...
# second reference locals
locals {
  metric_alerts = {
    "alert1" = {
      description   = "CPU Usage Alert"
      action_groups = ["actionGroup1", "actionGroup2"]
      criterias = {
        "criteria1" = {
          threshold        = 80
          metric_namespace = "Microsoft.Compute/virtualMachines"
    ...
    "alert2" = {
      ...
      // Here, dynamic_criteria is omitted, which is allowed by the optional directive.
    }
  }
}
